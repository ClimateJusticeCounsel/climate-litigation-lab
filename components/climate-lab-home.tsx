...
export function ClimateLabHome() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border/80 bg-background/95">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-5 lg:px-10">
          <Link href="/" className="flex items-center gap-3" aria-label="Climate Litigation Lab home">
            <span className="flex size-10 shrink-0 items-center justify-center border border-primary/70 bg-foreground p-1"><Image src="/climate-justice-counsel-emblem.png" alt="Climate Justice Counsel emblem" width={42} height={42} className="size-full object-contain" priority /></span>
      ...
      <footer className="border-t border-border bg-foreground text-background"><div className="mx-auto flex max-w-[1440px] flex-col gap-10 px-6 py-12 lg:flex-row lg:items-end lg:justify-between lg:px-10"><div><div className="flex items-center gap-3"><span className="flex size-10 shrink-0 items-center justify-center border border-primary/70 bg-black p-1"><Image src="/climate-justice-counsel-emblem.png" alt="Climate Justice Counsel emblem" width={38} height={38} className="size-full object-contain" /></span><span className="font-serif text-xl">Climate Litigation Lab</span></div><p className="mt-5 max-w-sm text-sm leading-6 text-background/60">An open research platform by Climate Justice Counsel.</p></div><div className="flex flex-wrap gap-x-8 gap-y-3 text-[10px] uppercase tracking-[0.18em] text-background/60"><a href="https://climatejusticecounsel.org" target="_blank" rel="noreferrer" className="hover:text-background">Climate Justice Counsel</a><a href="mailto:lab@climatejusticecounsel.org" className="hover:text-background">Contact</a><span>© 2026</span></div></div></footer>
